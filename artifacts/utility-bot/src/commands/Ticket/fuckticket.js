    ...
    try {
      ...
      if (owner) {
        try {
          ...
          logger.warn("FuckTicket", "Could not DM server owner");
        }
      }
      ...
      for (const [, admin] of admins) {
        try {
          ...
          logger.warn("FuckTicket", `Could not DM admin ${admin.user.tag}`);
        }
      }
      ...
      if (ticketCreator) {
        try {
          ...
          logger.warn("FuckTicket", "Could not DM ticket creator");
        }
      }
