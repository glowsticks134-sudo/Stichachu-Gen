...
class BumpCommand extends Command {
  ...
  _createSuccessContainer(result) {
    ...
    if (result.isSingle) {
      ...
      thumbnail = track.info.artworkUrl || config.assets?.defaultTrackArtwork || "https://cdn.discordapp.com/embed/avatars/0.png";
    } else {
      ...
      thumbnail = config.assets?.defaultTrackArtwork || "https://cdn.discordapp.com/embed/avatars/0.png";
    }
