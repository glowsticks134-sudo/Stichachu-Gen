  ...
  async _handleStop(context, pm) {
    ...
    const lastTrackInfo = wasPlaying
      ? {
          ...
          artworkUrl:
            wasPlaying.info.artworkUrl || config.assets?.defaultTrackArtwork || "https://cdn.discordapp.com/embed/avatars/0.png",
        }
      : null;
      ...
      container.addSectionComponents(
        new SectionBuilder()
          ...
          .setThumbnailAccessory(
            new ThumbnailBuilder().setURL(lastTrackInfo.artworkUrl || "https://cdn.discordapp.com/embed/avatars/0.png"),
          ),
      );
    } else {
