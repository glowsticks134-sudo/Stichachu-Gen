    ...
    if (result.type === "playing" || result.type === "queued") {
        ...
        new SectionBuilder()
          ...
          .setThumbnailAccessory(
            new ThumbnailBuilder().setURL(
              track.info.artworkUrl || config.assets?.defaultTrackArtwork || "https://cdn.discordapp.com/embed/avatars/0.png",
            ),
          ),
      );
      ...
      if (result.type === "queued" && premiumStatus) {
        ...
        container.addSectionComponents(
          new SectionBuilder()
            ...
            .setThumbnailAccessory(
              new ThumbnailBuilder().setURL(
                config.assets.queueIcon || config.assets?.defaultTrackArtwork || "https://cdn.discordapp.com/embed/avatars/0.png",
              ),
            ),
        );
      }
      ...
      container.addSectionComponents(
        new SectionBuilder()
          ...
          .setThumbnailAccessory(
            new ThumbnailBuilder().setURL(
              firstTrackArt || config.assets?.defaultTrackArtwork || "https://cdn.discordapp.com/embed/avatars/0.png",
            ),
          ),
      );
      ...
      if (
        ...
        container.addSectionComponents(
          new SectionBuilder()
            ...
            .setThumbnailAccessory(
              new ThumbnailBuilder().setURL(
                config.assets.premiumIcon || config.assets?.defaultTrackArtwork || "https://cdn.discordapp.com/embed/avatars/0.png",
              ),
            ),
        );
      }
      ...
      new SectionBuilder()
        ...
        .setThumbnailAccessory(
          new ThumbnailBuilder().setURL(
            ...
            config.assets?.defaultTrackArtwork || "https://cdn.discordapp.com/embed/avatars/0.png",
          ),
        ),
    );
  ...
  _createActionResultContainer(title, message) {
    ...
    container.addSectionComponents(
      new SectionBuilder()
        ...
        .setThumbnailAccessory(
          new ThumbnailBuilder().setURL(
            config.assets.successIcon || config.assets?.defaultTrackArtwork || "https://cdn.discordapp.com/embed/avatars/0.png",
          ),
        ),
    );
