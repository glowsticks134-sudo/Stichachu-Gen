                                ...
                                new SectionBuilder()
                                        ...
                                        .setThumbnailAccessory(
                                                new ThumbnailBuilder().setURL(
                                                        skippedTrack.info.artworkUrl || config.assets?.defaultTrackArtwork || "https://cdn.discordapp.com/embed/avatars/0.png",
                                                ),
                                        ),
                        );
        ...
        _createSuccessContainer(skipped, current, amount) {
                ...
                container.addSectionComponents(
                        new SectionBuilder()
                                ...
                                .setThumbnailAccessory(
                                        new ThumbnailBuilder().setURL(
                                                skipped.info.artworkUrl || config.assets?.defaultTrackArtwork || "https://cdn.discordapp.com/embed/avatars/0.png",
                                        ),
                                ),
                );
                ...
                if (current) {
                        ...
                        container.addSectionComponents(
                                new SectionBuilder()
                                        ...
                                        .setThumbnailAccessory(
                                                new ThumbnailBuilder().setURL(
                                                        current.info.artworkUrl || config.assets?.defaultTrackArtwork || "https://cdn.discordapp.com/embed/avatars/0.png",
                                                ),
                                        ),
                        );
                }
                ...
                collector.on("collect", async (interaction) => {
                        ...
                        container.addSectionComponents(
                                new SectionBuilder()
                                        ...
                                        .setThumbnailAccessory(
                                                new ThumbnailBuilder().setURL(
                                                        targetTrack.info.artworkUrl || config.assets?.defaultTrackArtwork || "https://cdn.discordapp.com/embed/avatars/0.png",
                                                ),
                                        ),
                        );
