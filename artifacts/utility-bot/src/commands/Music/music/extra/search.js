      ...
      currentResults.forEach((track, index) => {
        container.addSectionComponents(
          new SectionBuilder()
            ...
            .setThumbnailAccessory(new ThumbnailBuilder().setURL(track.info.artworkUrl || config.assets?.defaultTrackArtwork || "https://cdn.discordapp.com/embed/avatars/0.png"))
        );
      });
